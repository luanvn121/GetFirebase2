 ...
 */
public class Thang10Fragment extends Fragment {
    Firebase root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_thang10, container, false);
        Firebase.setAndroidContext(getActivity());

        mRecyclerView= (RecyclerView)rootView.findViewById(R.id.recycler10_view);

        root = new Firebase("https://kitestquocte.firebaseio.com/2016/10");
