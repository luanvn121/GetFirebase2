 ...
 */
public class Thang8Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_thang8, container, false);
        Firebase.setAndroidContext(getActivity());

        mRecyclerView= (RecyclerView)rootView.findViewById(R.id.recycler8_view);

        root = new Firebase("https://kitestquocte.firebaseio.com/2016/8");
